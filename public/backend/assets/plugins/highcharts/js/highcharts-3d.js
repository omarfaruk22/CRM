...
* Company Name: Smart Software LTD
* Terms & Conditions: https://smartsoftware.com.bd/terms-conditions
        ...
        function (a, l) {
            var u = l.pick,
                ...
                m = (a.perspective3D = function (d, k, h) {
                    k =
                        0 < h && h < Number.POSITIVE_INFINITY
                            ? h / (d.z + k.z + h)
                            : 1;
    ...
    B(
        ...
        function (a, l, u, d, m, w) {
            ...
            m.prototype.polyhedron = function (c) {
                ...
                f.faces = [];
                f.destroy = function () {
                    for (var c = 0; c < f.faces.length; c++)
                        f.faces[c].destroy();
                    return e.call(this);
                };
            ...
            var N = n(a, {
                ...
                animate: function (c, e, f) {
                    if (b(c.x) && b(c.y)) {
                        ...
                        g !== this.forcedSides &&
                            ((this.forcedSides = g),
                            N.fillSetter.call(this, this.fill));
                ...
                fillSetter: function (c) {
                    ...
                    this.singleSetterForParts("fill", null, {
                        ...
                        top: G(c)
                            .brighten(
                                0 <= this.forcedSides.indexOf("top") ? 0 : 0.1
                            )
                            .get(),
                        side: G(c)
                            .brighten(
                                0 <= this.forcedSides.indexOf("side") ? 0 : -0.1
                            )
                            .get(),
                    });
            ...
            m.prototype.arc3d = function (e) {
                ...
                f.setPaths = function (c) {
                    ...
                    f.attr({ zIndex: d });
                    c.center &&
                        (f.top.setRadialReference(c.center), delete c.center);
                };
                f.setPaths(e);
            ...
            var w = l.perspective,
                ...
                n = (function () {
                    ...
                    b.prototype.fix3dPosition = function (c, b) {
                        var d = this.axis,
                            e = d.chart;
                        if ("colorAxis" === d.coll || !e.chart3d || !e.is3d())
                            return c;
                        ...
                        b &&
                            ...
                            (e.matrix[4] -=
                                e.x * e.matrix[0] + e.y * e.matrix[2]),
                            (e.matrix[5] -=
                                e.x * e.matrix[1] + e.y * e.matrix[3]));
                        return e;
                    };
                ...
                a.wrapGetSlotWidth = function (c, d) {
                    ...
                    if (
                        ...
                        0 !== q &&
                            ...
                            m.label.xy &&
                            (p = k(
                                { x: m.label.xy.x, y: m.label.xy.y, z: null },
                                b,
                                b.vd
                            ));
                        a &&
                            a.label.xy &&
                            (g = k(
                                { x: a.label.xy.x, y: a.label.xy.y, z: null },
                                b,
                                b.vd
                            ));
            ...
            (function (a) {
                        ...
                        this.frameShapes.bottom[v]({
                            ...
                            faces: [
                                ...
                                },
                                {
                                    ...
                                    enabled:
                                        b.bottom.visible && !b.left.visible,
                                },
                                {
                                    fill: d
                                        .color(b.bottom.color)
                                    ...
                                    enabled:
                                        b.bottom.visible && !b.right.visible,
                                },
                                {
                                    ...
                                    enabled:
                                        b.bottom.visible && !b.front.visible,
                                },
                                {
                                    fill: d.color(b.bottom.color).get(),
                                    vertexes: [
                                    ...
                                    enabled:
                                        b.bottom.visible && !b.back.visible,
                                },
                            ],
                        });
                            ...
                            faces: [
                                {
                                    ...
                                    enabled:
                                        b.left.visible && !b.bottom.visible,
                                },
                                {
                                    fill: d
                                        .color(b.left.color)
                            ...
                            faces: [
                                {
                                    ...
                                    enabled:
                                        b.right.visible && !b.bottom.visible,
                                },
                                {
                                    fill: d
                                        .color(b.right.color)
                                ...
                                },
                                {
                                    ...
                                    enabled:
                                        b.right.visible && !b.front.visible,
                                },
                                {
                                    fill: d.color(b.right.color).get(),
                                    vertexes: [
                            ...
                            faces: [
                                {
                                    ...
                                    enabled:
                                        b.back.visible && !b.bottom.visible,
                                },
                                {
                                    fill: d
                                        .color(b.back.color)
                            ...
                            faces: [
                                {
                                    ...
                                    enabled:
                                        b.front.visible && !b.bottom.visible,
                                },
                                {
                                    fill: d
                                        .color(b.front.color)
                                ...
                                },
                                {
                                    ...
                                    enabled:
                                        b.front.visible && !b.right.visible,
                                },
                                {
                ...
                function v() {
                    ...
                    if (this.chart3d && this.is3d()) {
                        c &&
                            ((c.alpha =
                                (c.alpha % 360) + (0 <= c.alpha ? 0 : 360)),
                            (c.beta =
                                (c.beta % 360) + (0 <= c.beta ? 0 : 360)));
                        var b = this.inverted,
                            a = this.clipBox,
                            d = this.margin;
                        a[b ? "y" : "x"] = -(d[3] || 0);
                ...
                var D = (function () {
                    ...
                    c.prototype.get3dFrame = function () {
                        ...
                        var u = !1,
                            ...
                            G = !1;
                        []
                            .concat(c.xAxis, c.yAxis, c.zAxis)
                            .forEach(function (c) {
                                c &&
                                    (c.horiz
                                        ? c.opposite
        ...
        function (a, l, u) {
            ...
            a.Series.prototype.translate3dPoints = function () {
                ...
                for (p = 0; p < this.data.length; p++) {
                    ...
                    if (k && k.translate) {
                        var r =
                            k.logarithmic && k.val2lin ? k.val2lin(h.z) : h.z;
    ...
    B(
        ...
        function (a, l, u, d) {
            ...
            l(r, "afterInit", function () {
                if (this.chart.is3d() && this.handle3dGrouping) {
                    ...
                    if ("undefined" === typeof b || b) {
                        ...
                        for (
                            c = 0;
                            c < b[k].series.length && b[k].series[c] !== this;
                            c++
                        );
            ...
            b.columnrange &&
                ...
                d(
                    b.columnrange.prototype.pointClass.prototype,
                    "hasNewShapeType",
                    G
                ),
                (b.columnrange.prototype.plotGroup =
                    b.column.prototype.plotGroup),
                (b.columnrange.prototype.setVisible =
                    b.column.prototype.setVisible));
                ...
                if (this.chart.is3d()) {
                    ...
                    this.data.forEach(function (a) {
                        ...
                        var m = a.connectorPosition,
                            n =
                                -l *
                                (1 - Math.cos((h.alpha || k.alpha) * d)) *
                                Math.sin(b),
                            p =
                                l *
                                (Math.cos((h.beta || k.beta) * d) - 1) *
                                Math.cos(b);
                        [a.natural, m.breakAt, m.touchingSliceAt].forEach(
                            function (a) {
                                a.x += p;
                                a.y += n;
                            }
            ...
            l(
                ...
                },
                {
                    pointAttribs: function (a) {
                        var d = w.scatter.prototype.pointAttribs.apply(
                            this,
                            arguments
                        );
