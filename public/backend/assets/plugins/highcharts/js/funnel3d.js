        ...
        function (d, m, k, h) {
            ...
            k(
                ...
                },
                {
                    ...
                    alignDataLabel: function (a, b, c) {
                        var g = a.dlBoxRaw,
                            ...
                            e =
                                a.plotY >
                                C(this.translatedThreshold, this.yAxis.len),
                            d = C(c.inside, !!this.options.stacking),
                            f = { x: g.x, y: g.y, height: 0 };
                        c.align = C(
                            c.align,
                            !u || d ? "center" : e ? "right" : "left"
                        );
                        c.verticalAlign = C(
                            c.verticalAlign,
                            u || d ? "middle" : e ? "top" : "bottom"
                        );
                        "top" !== c.verticalAlign &&
                            (f.y +=
                                g.bottom /
                                ("bottom" === c.verticalAlign ? 1 : 2));
                        f.width = this.getWidthAt(f.y);
                        this.options.reversed &&
                            (f.width = g.fullWidth - f.width);
                        d
                            ? (f.x -= f.width / 2)
                            : "left" === c.align
                            ...
                            : (f.x -= f.width / 2);
                        a.dlBox = f;
                        K.column.prototype.alignDataLabel.apply(
                            this,
                            arguments
                        );
                    },
                },
                {
                    shapeType: "funnel3d",
                    hasNewShapeType:
                        d.seriesTypes.column.prototype.pointClass.prototype
                            .hasNewShapeType,
                }
            );
            k = p(m.elements3d.cuboid, {
                ...
                fillSetter: function (a) {
                    var b = this,
                        ...
                        g = c.rgba[3],
                        d = {
                            top: l(a).brighten(0.1).get(),
                            bottom: l(a).brighten(-0.2).get(),
                        };
                    1 > g
                        ? ((c.rgba[3] = 1),
                          (c = c.get("rgb")),
                    ...
                    c.linearGradient &&
                        [b.frontLower, b.frontUpper].forEach(function (a) {
                            (a =
                                (a = a.element) &&
                                b.renderer.gradients[a.gradient]) &&
            ...
            m.funnel3dPath = function (a) {
                ...
                var b = H[this.chartIndex],
                    c = (a.alphaCorrection =
                        90 -
                        Math.abs((b.options.chart.options3d.alpha % 180) - 90)),
                    d = L.call(
                        this,
                        p(a, {
                            depth: a.width,
