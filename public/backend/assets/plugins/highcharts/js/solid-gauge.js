                ...
                { colorByPoint: !0, dataLabels: { y: 0 } },
                {
                    ...
                    drawPoints: function () {
                        ...
                        v(b.threshold) &&
                            (k =
                                c.startAngleRad +
                                c.translate(b.threshold, null, null, null, !0));
                        ...
                        a.points.forEach(function (f) {
                            if (!f.isNull) {
                                var d = f.graphic,
                                    e =
                                        c.startAngleRad +
                                        c.translate(f.y, null, null, null, !0),
                                    k =
                                        (w(t(f.options.radius, b.radius, 100)) *
                                            g[2]) /
                                        200,
                                    n =
                                        (w(
                                            t(
                                                f.options.innerRadius,
                                                b.innerRadius,
                                                60
                                            )
                                        ) *
