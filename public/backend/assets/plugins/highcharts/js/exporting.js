                ...
                c.prototype.setButtonText = function () {
                    ...
                    (null === k || void 0 === k ? 0 : k.menuItemDefinitions) &&
                        ...
                        (h[l.indexOf("viewFullscreen")].innerHTML = this.isOpen
                            ? e.exitFullscreen
                            : k.menuItemDefinitions.viewFullscreen.text ||
                              e.viewFullscreen);
                };
                ...
                getSVGForExport: function (a, b) {
                    ...
                    return this.getSVG(
                        n({ chart: { borderRadius: 0 } }, f.chartOptions, b, {
                            exporting: {
                                sourceWidth:
                                    (a && a.sourceWidth) || f.sourceWidth,
                                sourceHeight:
                                    (a && a.sourceHeight) || f.sourceHeight,
                            },
                        })
                    );
                },
                ...
                contextMenu: function (a, b, f, d, c, h, k) {
                    ...
                    if (!m) {
                        ...
                        b.forEach(function (a) {
                            "string" === typeof a &&
                                (a =
                                    g.options.exporting.menuItemDefinitions[a]);
                            if (J(a, !0)) {
                    ...
                    b = { display: "block" };
                    f + g.exportMenuWidth > l
                        ? (b.right = l - f - c - v + "px")
                        : (b.left = f - v + "px");
                    d + h + g.exportMenuHeight > A &&
                ...
                addButton: function (a) {
                    ...
                    if (!1 !== d.enabled) {
                        ...
                        var r = f
                            ...
                            .attr({
                                title: q(
                                    b.options.lang[d._titleKey || d.titleKey],
                                    ""
                                ),
                            });
                        r.menuClassName =
            ...
            c.prototype.inlineStyles = function () {
                ...
                function b(c) {
                    ...
                    if (1 === c.nodeType && -1 === k.indexOf(c.nodeName)) {
                        ...
                        "svg" === c.nodeName &&
                            c.setAttribute("stroke-width", "1px");
                        "text" !== c.nodeName &&
