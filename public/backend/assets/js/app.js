...
$(function () {
    ...
    new PerfectScrollbar(".app-container"),
        ...
        //     alert("hello"); // Test if the click event is triggered successfully

        //     // Toggle the class "toggled" on the "wrapper" element
        //     $(".wrapper").toggleClass("toggled");

        //     // Toggle the class "sidebar-hovered" on the "wrapper" element based on hover events on "sidebar-wrapper"
