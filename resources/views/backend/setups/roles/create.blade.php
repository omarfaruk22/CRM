                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="permission">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input permission-checkbox" type="checkbox" name="permissions[]" value="{{ $permission->id }}" id="permission-checkbox-{{ $permission->id }}" data-prefix="{{$prefix}}">
