...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-8 mx-auto">
            <div class="card">
                <form action="{{ route('setup.custom-fields.update', $editfield->id) }}" method="post">
                    @csrf
                        ...
                        <div class="row g-3 needs-validation" novalidate="">
                            ...
                            <div class="col-md-12">
                                ...
                                <select id="fieldto" name="fieldto" class="form-select">
                                    ...
                                    @foreach ($fieldname as $data)
                                        <option
                                            value="{{ $data->field_name }}"@if ($editfield->fieldto == $data->field_name) selected @endif>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Field Name" value="{{ $editfield->name }}">
                                @error('name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <select id="type" name="type" class="form-select">
                                    ...
                                    @foreach ($typename as $item)
                                        <option value="{{ $item->field_type_name }}"
                                            @if ($editfield->type == $item->field_type_name) selected @endif>{{ $item->field_type_name }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('type')
                            ...
                            <div class="col-md-12 Select MultiSelect Chackbox dynamictype" style="display:none;">
                                ...
                                <textarea type="text" class="form-control" rows="4" name="options" id="options" placeholder="options">{{ $editfield->options }}</textarea>
                            ...
                            <div class="col-md-12 Textarea dynamictype">
                                ...
                                <textarea type="text" class="form-control" rows="4" name="default_value" id="default_value"
                                    placeholder="Default Value">{{ $editfield->default_value }}</textarea>
                            </div>
                            ...
                            <div
                                ...
                                <input type="text" class="form-control" name="default_value" id="default_value"
                                    placeholder="Default Value" value="{{ $editfield->default_value }}">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="number" class="form-control" name="field_order" id="field_order"
                                    placeholder="Order" value="{{ $editfield->field_order }}">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control" name="bs_column" id="bs_column"
                                        placeholder="12" value="{{ $editfield->bs_column }}">
                                </div>
                                @error('bs_column')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" name="active" type="checkbox" id="active"
                                        value="1" @if ($editfield->active == '1') checked @endif>
                            ...
                            <div class="col-md-12 Chackbox dynamictype" style="display:none;">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="display_inline"
                                        ...
                                        @if ($editfield->display_inline == '1') checked @endif>
                            ...
                            <div
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="only_admin" id="only_admin"
                                        value="1" @if ($editfield->only_admin == '1') checked @endif>
                            ...
                            <div class="col-md-12 Customers Contacts Tasks  dynamicFields" style="display:none;">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="disalow_client_to_edit"
                                        ...
                                        @if ($editfield->disalow_client_to_edit == '1') checked @endif>
                            ...
                            <div
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="required" id="required"
                                        value="1" @if ($editfield->required == '1') checked @endif>
                            ...
                            <div
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="show_on_table"
                                        ...
                                        @if ($editfield->show_on_table == '1') checked @endif>
                            ...
                            <div style="display:none;"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="show_on_client_portal"
                                        ...
                                        @if ($editfield->show_on_client_portal == '1') checked @endif>
                            ...
                            <div class="col-md-12 Invoice Items CreditNote Estimate dynamicFields" style="display:none;">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="show_on_pdf" id="show_on_pdf"
                                        value="1" @if ($editfield->show_on_pdf == '1') checked @endif>
                            ...
                            <div class="col-md-12 Tickets dynamicFields" style="display:none;">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="show_on_ticket_form"
                                        ...
                                        @if ($editfield->checkbox == '1') checked @endif>
    ...
    <script>
        $(document).ready(function() {
            function handleFieldChange() {
                var selectedOption = $("#fieldto").val().split(' ').join('');
                ...
                if (selectedOption === 'Leads' || selectedOption === 'Staff' || selectedOption === 'Expenses') {
                ...
                if (selectedOption === 'Customers' || selectedOption === 'Contacts' || selectedOption ===
                    'Contracts' || selectedOption === 'Tasks' || selectedOption === 'Invoice' || selectedOption ===
                    'CreditNote' || selectedOption === 'Estimate' || selectedOption === 'Proposal' ||
                    selectedOption === 'Projects' || selectedOption === 'Tickets') {
                    $('#only_admin').change(function() {
                        if ($(this).is(':checked')) {
                            $('#show_on_client_portal').prop('disabled', true).prop('checked', false);
                            $('#disalow_client_to_edit').prop('disabled', true).prop('checked', false);
                        } else {
            ...
            // Call the function when select field changes
