				...
				<nav class="navbar navbar-expand gap-3">
						...
						<ul class="navbar-nav align-items-center gap-1">
							...
							<li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
								...
								<ul class="dropdown-menu dropdown-menu-end">
									<li>
										<a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{ asset('backend/assets/images/county/02.png') }}" width="20" alt=""><span class="ms-2">English</span></a>
									</li>
									<li>
										<a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="assets/images/county/02.png" width="20" alt=""><span class="ms-2">Bangla</span></a>
									</li>
								</ul>
							</li>
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{ asset('backend/assets/images/default.jpg') }}" class="user-img" alt="user avatar">
							<div class="user-info">
