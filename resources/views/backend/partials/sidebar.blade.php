<ul class="metismenu" id="menu">
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                <a href=" {{ route('sales.estimates') }} "><i class='bx bx-radio-circle'></i>Estimates</a>
            </li>
            <li>
                <a href="{{ route('sales.invoice') }}"><i class='bx bx-radio-circle'></i>Invoices</a>
            </li>
            <li>
                <a href="{{ route('sales.payment') }}"><i class='bx bx-radio-circle'></i>Payments</a>
            </li>
            <li>
                <a href="{{ route('sales.credit.note') }}"><i class='bx bx-radio-circle'></i>Credit Notes</a>
            </li>
            <li>
                <a href="{{ route('sales.items') }}"><i class='bx bx-radio-circle'></i>Items</a>
            </li>
        </ul>
    </li>
    <li>
    ...
    <li>
        <a href="{{ route('mainexpense.index') }}">
    ...
    <li>
        <a href="{{ route('maincontract.index') }}">
    ...
    <li>
        ...
        <ul>
            <li>
                <a href="{{ route('utilities.media') }}"><i class='bx bx-radio-circle'></i>Media</a>
            </li>
            <li>
                <a href="{{ route('utilities.bulkpdf') }}"><i class='bx bx-radio-circle'></i>Bulk PDF Export</a>
            </li>
            <li>
                <a href="{{ route('utilities.csvexport') }}"><i class='bx bx-radio-circle'></i>CSV Export</a>
            </li>
            <li>
                <a href="{{ route('utilities.calender') }}"><i class='bx bx-radio-circle'></i>Calender</a>
            </li>
            <li>
                <a href="{{ route('utilities.announcements') }}"><i class='bx bx-radio-circle'></i>Announcements</a>
            </li>
            <li>
                <a href="{{ route('utilities.activity') }}"><i class='bx bx-radio-circle'></i>Activity Log</a>
            </li>
            <li>
                <a href="{{ route('utilities.database') }}"><i class='bx bx-radio-circle'></i>Database Backup</a>
            </li>
            <li>
                <a href="{{ route('utilities.ticketpipe') }}"><i class='bx bx-radio-circle'></i>Ticket Pipe Log</a>
            </li>
        </ul>
    ...
    <li>
        ...
        <ul>
            <li>
                <a href="{{ route('reports.sales') }}"><i class='bx bx-radio-circle'></i>Sales</a>
            </li>
            <li>
                <a href="{{ route('reports.expenses') }}"><i class='bx bx-radio-circle'></i>Expenses</a>
            </li>
            <li>
                <a href="{{ route('reports.expensesVsIncome') }}"><i class='bx bx-radio-circle'></i>Expenses vs
                    Income</a>
            </li>
            <li>
                <a href="{{ route('reports.leads') }}"><i class='bx bx-radio-circle'></i>Leads</a>
            </li>
            <li>
                <a href="{{ route('reports.timesheet') }}"><i class='bx bx-radio-circle'></i>Timesheets overview</a>
            </li>
            <li>
                <a href="{{ route('reports.kbarticles') }}"><i class='bx bx-radio-circle'></i>KB Articles</a>
            </li>
    ...
    <li>
        ...
        <ul>
            ...
            <li><a class="has-arrow" href="javascript:;"><i class='bx bx-radio-circle'></i>Customers</a>
                <ul>
                    <li>
            ...
            <li><a class="has-arrow" href="javascript:;"><i class='bx bx-radio-circle'></i>Support</a>
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('support.services.index') }}"><i
            ...
            <li><a class="has-arrow" href="javascript:;"><i class="bx bx-radio-circle"></i>Contracts</a>
                <ul>
                    <li><a href="{{ route('setup.contract.index') }}">
                            <i class="bx bx-radio-circle"></i>Contracts Type</a>
                    </li>
                </ul>
            </li>
            <li><a class="has-arrow" href="javascript:;"><i class="bx bx-radio-circle"></i>Estimate Request</a>
                <ul>
                    <li>
            ...
            <li><a class="has-arrow" href="javascript:;"><i class="bx bx-radio-circle"></i>Menu Setup</a>
                <ul>
                    <li>
                        <a href="{{ route('setup.menu_setup.main_menu') }}"><i class="bx bx-radio-circle"></i>Main
                            Menu</a>
                    </li>
                    <li>
                        <a href="{{ route('setup.menu_setup.setup_menu') }}"><i class="bx bx-radio-circle"></i>Setup
                            Menu</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="javascript:;"><i class='bx bx-radio-circle'></i>Help</a>
            </li>
        </ul>
    </li>
</ul>
