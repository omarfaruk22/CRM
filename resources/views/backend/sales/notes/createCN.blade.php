...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">New Credit Note</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page"> Credit Note Add View</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                        ...
                        <div id="invoicefirst">
                            <div class="row mb-4">
                                <div class="col-md-2">
                                    ...
                                    <textarea type="text" class="form-control" id="item" placeholder="Item"></textarea>
                                </div>
                                <div class="col-md-2">
