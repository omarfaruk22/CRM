...
@section('content')
    ...
    @include('backend.sales.estimates.estimatemodal')

    <!--breadcrumb-->
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">New Estimate</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page"> Sales Estimate Create View</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row mb-3">
                                    <div class="col-12 customer-box mb-3">
                                        ...
                                        <div class="input-group">
                                            <div class="btn border border-secondary">EST-</div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="invoiceDate" class="form-label"> * Estimate Date </label>
                                        <input type="date" class="form-control" name="estimate_date" id="invoiceDate">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="open_till" class="form-label"> Expiry Date </label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row mb-4">
                                    <div class="col">
                                        <label for="proposalTo" class="form-label">Reference #</label>
                                        <input type="text" class="form-control" name="referance" id="proposalTo">
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-group mb-3">
                                                ...
                                                <button class="btn btn-outline-secondary" type="button"
                                                    ...
                                                    data-bs-target="#addItemModalestimate">+</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-7 d-flex align-items-center justify-content-end">
                                                ...
                                                <div class="input-group w-auto me-2">
                                                    ...
                                                    <div id="fixedamount" style="display: none;">
                                                        <input type="number" name="discount_fixedAmount"
                                                            class="form-control" placeholder="Fixed Amount">
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('#addTaskSelect').change(function() {
                ...
                $.ajax({
                    url: "{{ route('fetch-item-data-estimate') }}",
                    type: 'GET',
                    data: {
