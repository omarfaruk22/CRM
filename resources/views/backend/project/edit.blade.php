...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="mt-3 mb-3">Edit project</h4>
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <form action="{{ route('projects.update', $projects->id) }}" method="post"
                                            ...
                                            <select name="customer_id" class="form-select select2" id="customer_id">
                                                @if (!empty($customers))
                                                    ...
                                                    @foreach ($customers as $customer)
                                                        <option
                                                            value="{{ $customer->id }}"{{ $customer->id == $projects->customer_id ? 'selected' : '' }}>
                                                            {{ $customer->company }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-check form-check-success">
                                                <input class="form-check-input" type="checkbox"
                                                    name="progress_from_tasks" value="1"
                                                    id="progress_from_tasks"{{ $projects->progress_from_tasks == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <select name="billing_type"
                                                ...
                                                @foreach ($billing_types as $key => $billing_type)
                                                    <option
                                                        value="{{ $key }}"{{ $projects->billing_type == $key ? 'selected' : '' }}>
                                                        {{ $billing_type }}</option>
                                                @endforeach
                                            </select>
                                            @error('billing_type')
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <select name="status" class="form-select select2" id="status"
                                                ...
                                                @foreach ($statuses as $key => $status)
                                                    <option
                                                        value="{{ $key }}"{{ $projects->status == $key ? 'selected' : '' }}>
                                                        {{ $status }}</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-12 mb-2 totalrate d-none">
                                            ...
                                            <input type="number" name="project_cost" class="form-control"
                                                id="totalrate" value="{{ $projects->project_cost }}">
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-2 rate_per_hour d-none">
                                            ...
                                            <input type="number" name="rate_per_hour" class="form-control"
                                                id="rate_per_hour" value="{{ $projects->rate_per_hour }}">
                                        </div>

                                        <div class="col-md-6 mb-2">
                                            <label for="estimated_hours" class="form-label">Estimated Hours</label>
                                            <input type="number" name="estimated_hours" class="form-control"
                                                id="estimated_hours" value="{{ $projects->estimated_hours }}">
                                        </div>
                                            ...
                                            <select name="project_members[]" class="form-select select2"
                                                ...
                                                @if (!empty($users))
                                                    @foreach ($users as $user)
                                                        <option
                                                            value="{{ $user->id }}"{{ in_array($user->id, $projectmembers) ? 'selected' : '' }}>
                                                            {{ $user->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <select id="tags" name="tags[]" class="form-select select2"
                                                ...
                                                @if (!empty($tags))
                                                    @foreach ($tags as $tag)
                                                        <option
                                                            value="{{ $tag->id }}"{{ in_array($tag->id, $taggs) ? 'selected' : '' }}>
                                                            {{ $tag->tags }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <textarea id="editor" name="description">{{ $projects->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-check form-check-secondary">
                                                <input class="form-check-input" type="checkbox" value="1"
                                                    ...
                                                    {{ $projects->send_created_email == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <select name="contact_notification"
                                                ...
                                                <option></option>
                                                <option
                                                    value="1"{{ isset($projects) && $projects->contact_notification == 1 ? 'selected' : '' }}>
                                                    To
                                                    all contacts with notifications for projects
                                                    enabled</option>
                                                <option
                                                    value="2"{{ isset($projects) && $projects->contact_notification == 2 ? 'selected' : '' }}>
                                                    Specific contacts</option>
                                                <option
                                                    value="0"{{ isset($projects) && $projects->contact_notification == 0 ? 'selected' : '' }}>
                                            ...
                                            <select id="available_features" name="available_features[]"
                                                ...
                                                @forelse ($projectvissiabletabs as $key => $projectvissiabletab)
                                                    @if ($key >= 9 && $key <= 14)
                                                        ...
                                                        @endif
                                                        <option
                                                            value="{{ $projectvissiabletab->value }}"{{ isset($available_features) && in_array($projectvissiabletab->value, explode(',', $available_features->value)) ? 'selected' : '' }}>
                                        ...
                                        <div>
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="view_tasks"
                                                            id="view_tasks"
                                                            value="1"{{ isset($view_tasks) && $view_tasks->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input check" type="checkbox"
                                                            name="create_tasks" id="create_tasks"
                                                            value="1"{{ isset($create_tasks) && $create_tasks->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input check" type="checkbox"
                                                            name="edit_tasks" id="edit_tasks"
                                                            value="1"{{ isset($edit_tasks) && $edit_tasks->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input check" type="checkbox"
                                                            name="comment_on_tasks" id="comment_on_tasks"
                                                            value="1"{{ isset($comment_on_tasks) && $comment_on_tasks->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input check" type="checkbox"
                                                            ...
                                                            value="1"{{ isset($view_task_comments) && $view_task_comments->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input check" type="checkbox"
                                                            ...
                                                            value="1"{{ isset($view_task_attachments) && $view_task_attachments->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input check" type="checkbox"
                                                            ...
                                                            id="view_task_checklist_items"
                                                            value="1"{{ isset($view_task_checklist_items) && $view_task_checklist_items->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input check" type="checkbox"
                                                            name="upload_on_tasks" id="upload_on_tasks"
                                                            value="1"{{ isset($upload_on_tasks) && $upload_on_tasks->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input check" type="checkbox"
                                                            ...
                                                            id="view_task_total_logged_time"
                                                            value="1"{{ isset($view_task_total_logged_time) && $view_task_total_logged_time->value == 1 ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            value="1"{{ isset($view_finance_overview) && $view_finance_overview->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="upload_files" id="upload_files"
                                                            value="1"{{ isset($upload_files) && $upload_files->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="open_discussions" id="open_discussions"
                                                            value="1"{{ isset($open_discussions) && $open_discussions->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="view_milestones" id="view_milestones"
                                                            value="1"{{ isset($view_milestones) && $view_milestones->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="view_gantt"
                                                            id="view_gantt"
                                                            value="1"{{ isset($view_gantt) && $view_gantt->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="view_timesheets" id="view_timesheets"
                                                            value="1"{{ isset($view_timesheets) && $view_timesheets->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            value="1"{{ isset($view_activity_log) && $view_activity_log->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            value="1"{{ isset($view_team_members) && $view_team_members->value == 1 ? 'checked' : '' }}>
                                                ...
                                                <li class="list-group-item" style="padding-left: 0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="hide_tasks_on_main_tasks_table"
                                                            value="1"{{ isset($hide_tasks_on_main_tasks_table) && $hide_tasks_on_main_tasks_table->value == 1 ? 'checked' : '' }}>
                                                        <label class="form-check-label"
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            function notify_disabled() {
                var value = $('#contact_notification').val();
                if (value == 2) {
