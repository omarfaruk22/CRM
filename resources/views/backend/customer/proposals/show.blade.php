        ...
        <div class="row">
            ...
            <div class="d-flex justify-content-between">
                <div class="mb-2">
                    ...
                    <div class="mb-2">
                        <button type="button" class="btn btn-outline-secondary btn-sm px-2"><i class="fa-solid fa-file-pdf"></i> Download</button>
									...
									<div class="tab-pane fade active show" id="primary-pills-home" role="tabpanel">
                                        ...
                                        <hr>
                                            ...
                                            <div class="tw-text-normal col-md-4 text-muted proposal-status">
                                                ...
                                                <div class="tw-text-normal col-md-8 proposal-status tw-text-neutral-700">Declined</div>
                                                <div class="tw-text-normal col-md-4 text-muted proposal-date"> Date  </div>
                                                <div class="tw-text-normal col-md-8 proposal-date tw-text-neutral-700">30/03/2024 </div>
                                                <div class="tw-text-normal col-md-4 text-muted proposal-open-till">Open Till </div>
                                                <div class="tw-text-normal col-md-8 proposal-open-till tw-text-neutral-700">06/04/2024 </div>
                                            </div>
                                        </div>
                                        	<div class="col-md-12 mb-5">
                                                 <div class="row ">
