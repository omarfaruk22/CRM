...
<div class="row">
    <div class="col-md-3">
        <h4 class="mt-3 mb-3">#8 Barton PLC</h4>
            ...
            <div class="card-body">
                <div id="invoice">
                    <div class="d-flex justify-content-between">
                        <div class="col-md-4">
                            <select class="form-control mb-2" id="selectOption" onchange="showSelected()">
                        ...
                        <div class="text-end col-md-8">
                            <a type="button" class="btn btn-white"><i class='bx bx-printer'></i></a>
                            <a type="button" class="btn btn-white"><i class='bx bxs-envelope'></i></a>
                            <a type="button" class="btn btn-white"><i class='bx bxs-file-pdf'></i></a>
                        </div>
                    </div>
                    <hr>
                    <div class="d-flex justify-content-between my-3">
                        <div class="mb-2">
                            <h5>Customer Statement For Barton PLC</h5>
                        </div>
